...
class CardSpecialOffer extends StatelessWidget {
  ...
  CardSpecialOffer(double height, double width, double padding, String image, String name){
    this.height = height;
    this.width = width;
      ...
      child: Stack(
        children: <Widget>[
          Align(
            ...
            child: Padding(
              padding: EdgeInsets.only(top: topBottomPadding*5, bottom: topBottomPadding),
              child: Container(
                height: height,
                width: width,
                child: Card(
